...
const Home: FC = () => {
    ...
    const {searchValue,categoryValue, sortValue, pageChosen} = useSelector((state: RootState) => state.filterSlice)
        ...
        <>
            <div className="content__top">
                ...
                <Categories
                    ...
                    setCategoryChoice={React.useCallback((value: number) => dispatch(setCategoryValue(value)), [])}
                />
